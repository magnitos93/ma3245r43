...
{
    // первичные данные
    private $token = "6356718999:AAH0Qi37zO4nDRYb5wmXPJkjKuLdQsAI9DA";
    private $admin = 745940954; // Ваш id в ТЕЛеГРАМ
    private $helloText = "Приветствую \n<b>Чат-Бот-Магазин</b>\n /lc - заказы";
    private $img_path = "/var/www/s249542/data/public_html/imgmag1"; // путь до директории с картинками относительно этого файла


    // Яндекс.Кошелек для приема оплаты
    private $receiver = "+79384078080";
    // адрес на который переадресует пользователя в случае успешного платежа
    private $urlBot = "t.me/telebz";
    // название магазина
    ...
    private $db = 'free_energy_cf_fa0c';
    private $user = 'free_energy_cf_fa0c';
    private $pass = 'cTXX9Z1x87VHh8he';
